...
const ProjectDetails = () => {
  ...
  const handleViewClick = (id: string, phaseName: string) => {
    ...
    if (id && phaseName) {
      ...
      router.push(`/client/materialschedule/${id}?color=${encodeURIComponent(color)}&phaseName=${encodeURIComponent(phaseName)}&contactNumber=${encodeURIComponent(contactNumber || '')}`);
    } else {
