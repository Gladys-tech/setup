...
const ProjectDetails = () => {
    ...
    return (
        <Box p={2} sx={{ minHeight: '100vh', overflow: 'hidden' }}>
            
            {/* Header section with back button, project name, and project details button */}
            <Box sx={{
                display: 'flex',
                alignItems: 'center',
                            ...
                            .map((phase, index) => (
                                <Box key={index} mb={3} display="flex" alignItems="center" sx={{ cursor: 'pointer' }}
                                    ...
                                    <Typography sx={{ fontSize: '16px', ml: 3 }}>
                                        Total for <span style={{ color: theme.palette.primary.main, fontWeight: 'bold' }}>{phase.name}</span>
                                    </Typography>
                                </Box>
                            ))}
                    </Box>
